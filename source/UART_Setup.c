...
#define TRIS_U1TX       (TRISBbits.TRISB4 = 0)
#define TRIS_U1RX       (TRISBbits.TRISB5 = 1)
#define MAP_U1TX        (PPSOutput(OUT_FN_PPS_U1TX, OUT_PIN_PPS_RP4))
#define MAP_U1RX        (PPSInput(PPS_U1RX, PPS_RP5))
